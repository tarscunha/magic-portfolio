---
title: "Transforming Firebase App Distribution into a full-fledged testing product"
publishedAt: "2024-04-08"
summary: "This feature expands App Distribution from a platform used primarily for circumventing app store restrictions into a more robust testing tool. Automatic tests complement existing human testing workflows.
"
images:
  - "/images/projects/project-01/mata2.jpg"
...
team:
  - name: "Tars Cunha"
    ...
    linkedIn: "https://www.linkedin.com/in/tars-cunha/"
link: "https://firebase.google.com/products/app-distribution"
---

## Overview

This feature expands App Distribution from a platform used primarily for circumventing app store restrictions into a more robust testing tool. Automatic tests complement existing human testing workflows.
...
![Project screenshot](/images/projects/project-01/avatar-01.jpg)
## Technologies Used
